...
Instructions for reproducing the paper's calculations, tables and figures are contained in the files '[GrammarSocialResponsibility.html](https://github.com/cokelly/Grammar-of-CSR/notebooks/GrammarSocialResponsibility.html)' or '[GrammarSocialResponsiiblity.Rmd](https://github.com/cokelly/Grammar-of-CSR/notebooks/GrammarSocialResponsibility.Rmd)' in the 'notebooks' folder. Using RStudio it is easy to process this file as a notebook and read as an html file to be opened and read in a browser such as Firefox or Chrome.
